...
export const canonicalFields: Record<CanonicalEntityType, Record<string, CanonicalFieldDefinition>> = {
  ...
  JOB: { ...common, customerExternalId: { relation: true, type: "string" }, estimateExternalId: { relation: true, type: "string" }, status: { type: "string" }, contractValueCents: { type: "money" }, contractValueIncludesApprovedChanges: { type: "boolean" }, currency: { type: "string" }, owner: { type: "string" }, source: { type: "string" }, serviceType: { type: "string" }, targetGrossMarginBps: { type: "percentage" }, scopeChangeFlag: { type: "boolean" }, notes: { type: "string" }, startedAt: { type: "date" }, completedAt: { type: "date" } },
