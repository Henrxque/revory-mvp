...
const aliases: Record<CanonicalEntityType, Record<string, readonly string[]>> = {
  ...
  ESTIMATE: {
    ...
    status: ["estimate status", "quote status", "proposal status", "bid status", "status", "stage"],
    amountCents: ["estimate amount", "quote amount", "proposal amount", "bid amount", "estimate total", "quote total", "bid total", "total", "amount", "value"],
    ...
    lastActivityAt: ["last activity", "last activity at", "last activity date", "last contact", "last contact date"],
