...
const billingPlanCatalog: Record<RevoryBillingPlan, RevoryBillingPlanDefinition> = {
  BASIC: {
    ...
    fitLabel: "Entry plan",
    framing:
      "A lower-friction entry plan for a limited revenue leak read without Growth's premium action and summary tools.",
    inAppSignal: "Entry plan with a limited revenue leak read.",
    key: "BASIC",
    label: "Basic",
    supportPoints: [
      "Limited estimated revenue at risk read",
      "Import-first structured clinic data intake",
  ...
  GROWTH: {
    ...
    label: "Growth",
    supportPoints: [
      "Full estimated revenue at risk read",
