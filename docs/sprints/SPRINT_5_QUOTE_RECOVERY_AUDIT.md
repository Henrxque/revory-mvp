...
The exit gate is **failed/blocked**: a test customer cannot yet complete sandbox payment and webhook fulfillment. Per the continuous execution guide, Sprint 6 must not be implemented or called complete until this gate and the Sprint 4 browser gate pass.
