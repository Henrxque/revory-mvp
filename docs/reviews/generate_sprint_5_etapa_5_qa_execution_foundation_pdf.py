...
SOURCE = ROOT / "sprint-5-etapa-5-qa-execution-foundation.md"
OUTPUT = ROOT / "sprint-5-etapa-5-qa-execution-foundation.pdf"
...
def main():
    ...
    doc = SimpleDocTemplate(
        ...
        topMargin=18 * mm,
        bottomMargin=18 * mm,
        title="REVORY Sprint 5 Etapa 5 QA Execution Foundation",
        author="Codex",
    )
