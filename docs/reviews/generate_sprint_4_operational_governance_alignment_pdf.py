...
SOURCE = ROOT / "sprint-4-operational-governance-alignment.md"
OUTPUT = ROOT / "sprint-4-operational-governance-alignment.pdf"
...
def main():
    ...
    doc = SimpleDocTemplate(
        ...
        topMargin=18 * mm,
        bottomMargin=18 * mm,
        title="REVORY Sprint 4 Governance Alignment Review",
        author="Codex",
    )
