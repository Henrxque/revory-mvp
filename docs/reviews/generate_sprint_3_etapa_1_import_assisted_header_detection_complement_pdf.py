...
SOURCE = ROOT / "sprint-3-etapa-1-import-assisted-header-detection-complement.md"
OUTPUT = ROOT / "sprint-3-etapa-1-import-assisted-header-detection-complement.pdf"
...
def main():
    ...
    doc = SimpleDocTemplate(
        ...
        topMargin=18 * mm,
        bottomMargin=18 * mm,
        title="REVORY Sprint 3 Etapa 1 Complement Review",
        author="Codex",
    )
