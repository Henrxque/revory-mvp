...
SOURCE = ROOT / "sprint-5-etapa-2-operational-state-foundation.md"
OUTPUT = ROOT / "sprint-5-etapa-2-operational-state-foundation.pdf"
...
def main():
    ...
    doc = SimpleDocTemplate(
        ...
        topMargin=18 * mm,
        bottomMargin=18 * mm,
        title="REVORY Sprint 5 Etapa 2 Operational State Foundation",
        author="Codex",
    )
