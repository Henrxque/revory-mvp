...
SOURCE = ROOT / "sprint-5-etapa-4-email-outreach-preparation-foundation.md"
OUTPUT = ROOT / "sprint-5-etapa-4-email-outreach-preparation-foundation.pdf"
...
def main():
    ...
    doc = SimpleDocTemplate(
        ...
        topMargin=18 * mm,
        bottomMargin=18 * mm,
        title="REVORY Sprint 5 Etapa 4 Email Outreach Preparation Foundation",
        author="Codex",
    )
