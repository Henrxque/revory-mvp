...
SOURCE = ROOT / "sprint-3-etapa-5-qa-import-assisted-rerun.md"
OUTPUT = ROOT / "sprint-3-etapa-5-qa-import-assisted-rerun.pdf"
...
def main():
    ...
    doc = SimpleDocTemplate(
        ...
        topMargin=18 * mm,
        bottomMargin=18 * mm,
        title="REVORY Sprint 3 Etapa 5 QA Import Assisted Rerun",
        author="Codex",
    )
