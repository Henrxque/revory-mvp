...
SOURCE = ROOT / "sprint-4-etapa-7-review-request-eligibility-base.md"
OUTPUT = ROOT / "sprint-4-etapa-7-review-request-eligibility-base.pdf"
...
def main():
    ...
    doc = SimpleDocTemplate(
        ...
        topMargin=18 * mm,
        bottomMargin=18 * mm,
        title="REVORY Sprint 4 Etapa 7 Review",
        author="Codex",
    )
