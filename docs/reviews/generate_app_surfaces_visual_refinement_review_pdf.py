...
SOURCE = ROOT / "app-surfaces-visual-refinement-review.md"
OUTPUT = ROOT / "app-surfaces-visual-refinement-review.pdf"
...
def render_markdown(md_text: str):
    ...
    for raw_line in md_text.splitlines():
        ...
        if line.startswith("  "):
            story.append(Paragraph(escape(line.strip()), styles["BodyIndented"]))
            continue
...
def main():
    ...
    doc = SimpleDocTemplate(
        ...
        topMargin=18 * mm,
        bottomMargin=18 * mm,
        title="REVORY App Surfaces Visual Refinement Review",
        author="Codex",
    )
