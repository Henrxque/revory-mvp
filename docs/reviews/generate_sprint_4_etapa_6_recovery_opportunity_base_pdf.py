...
SOURCE = ROOT / "sprint-4-etapa-6-recovery-opportunity-base.md"
OUTPUT = ROOT / "sprint-4-etapa-6-recovery-opportunity-base.pdf"
...
def main():
    ...
    doc = SimpleDocTemplate(
        ...
        topMargin=18 * mm,
        bottomMargin=18 * mm,
        title="REVORY Sprint 4 Etapa 6 Review",
        author="Codex",
    )
