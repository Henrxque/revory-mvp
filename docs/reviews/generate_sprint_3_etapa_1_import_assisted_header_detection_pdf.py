...
SOURCE = ROOT / "sprint-3-etapa-1-import-assisted-header-detection.md"
OUTPUT = ROOT / "sprint-3-etapa-1-import-assisted-header-detection.pdf"
...
def main():
    ...
    doc = SimpleDocTemplate(
        ...
        topMargin=18 * mm,
        bottomMargin=18 * mm,
        title="REVORY Sprint 3 Etapa 1 Review",
        author="Codex",
    )
