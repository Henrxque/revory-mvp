...
SOURCE = ROOT / "sprint-6-controlled-execution-framing.md"
OUTPUT = ROOT / "sprint-6-controlled-execution-framing.pdf"
...
def main():
    ...
    doc = SimpleDocTemplate(
        ...
        topMargin=18 * mm,
        bottomMargin=18 * mm,
        title="REVORY Sprint 6 Controlled Execution Framing",
        author="Codex",
    )
