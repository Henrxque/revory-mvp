...
SOURCE = ROOT / "sprint-5-etapa-3-action-readiness-surface.md"
OUTPUT = ROOT / "sprint-5-etapa-3-action-readiness-surface.pdf"
...
def main():
    ...
    doc = SimpleDocTemplate(
        ...
        topMargin=18 * mm,
        bottomMargin=18 * mm,
        title="REVORY Sprint 5 Etapa 3 Action Readiness Surface",
        author="Codex",
    )
