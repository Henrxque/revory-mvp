...
SOURCE = ROOT / "sprint-4-etapa-11-product-review-guard.md"
OUTPUT = ROOT / "sprint-4-etapa-11-product-review-guard.pdf"
...
def main():
    ...
    doc = SimpleDocTemplate(
        ...
        topMargin=18 * mm,
        bottomMargin=18 * mm,
        title="REVORY Sprint 4 Etapa 11 Product Review Guard",
        author="Codex",
    )
