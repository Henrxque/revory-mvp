...
SOURCE = ROOT / "sprint-6-operational-surface-guardrails.md"
OUTPUT = ROOT / "sprint-6-operational-surface-guardrails.pdf"
...
def main():
    ...
    doc = SimpleDocTemplate(
        ...
        topMargin=18 * mm,
        bottomMargin=18 * mm,
        title="REVORY Sprint 6 Operational Surface Guardrails",
        author="Codex",
    )
