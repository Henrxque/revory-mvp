...
SOURCE = ROOT / "sprint-6-qa-operational-regression-review.md"
OUTPUT = ROOT / "sprint-6-qa-operational-regression-review.pdf"
...
def main():
    ...
    doc = SimpleDocTemplate(
        ...
        topMargin=18 * mm,
        bottomMargin=18 * mm,
        title="REVORY Sprint 6 QA Operational Regression Review",
        author="Codex",
    )
