...
SOURCE = ROOT / "sprint-6-operational-ui-final-polish.md"
OUTPUT = ROOT / "sprint-6-operational-ui-final-polish.pdf"
...
def main():
    ...
    doc = SimpleDocTemplate(
        ...
        topMargin=18 * mm,
        bottomMargin=18 * mm,
        title="REVORY Sprint 6 Operational UI Final Polish",
        author="Codex",
    )
