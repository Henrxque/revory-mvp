...
SOURCE = ROOT / "sprint-4-etapa-10-qa-operational-layer-rerun.md"
OUTPUT = ROOT / "sprint-4-etapa-10-qa-operational-layer-rerun.pdf"
...
def main():
    ...
    doc = SimpleDocTemplate(
        ...
        topMargin=18 * mm,
        bottomMargin=18 * mm,
        title="REVORY Sprint 4 Etapa 10 QA Rerun",
        author="Codex",
    )
