...
SOURCE = ROOT / "sprint-5-etapa-6-product-review-guard.md"
OUTPUT = ROOT / "sprint-5-etapa-6-product-review-guard.pdf"
...
def main():
    ...
    doc = SimpleDocTemplate(
        ...
        topMargin=18 * mm,
        bottomMargin=18 * mm,
        title="REVORY Sprint 5 Etapa 6 Product Review Guard",
        author="Codex",
    )
