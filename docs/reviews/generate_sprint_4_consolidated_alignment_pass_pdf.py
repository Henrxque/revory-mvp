...
SOURCE = ROOT / "sprint-4-consolidated-alignment-pass.md"
OUTPUT = ROOT / "sprint-4-consolidated-alignment-pass.pdf"
...
def main():
    ...
    doc = SimpleDocTemplate(
        ...
        topMargin=18 * mm,
        bottomMargin=18 * mm,
        title="REVORY Sprint 4 Consolidated Alignment Pass",
        author="Codex",
    )
