...
- the Sprint 11 paid-beta exit remains closed exclusively on external MFA, environment parity, Stripe/Resend/OAuth E2E, production monitoring, managed backup restore, DAST/pentest, dependency review and qualified final legal review;
