...
- dedicated Audit/Starter entitlement and checkout code exists, and the founder-authorized Stripe sandbox contains the US$799 paid-once Audit plus US$399/month Starter prices; secret/webhook wiring and end-to-end payment evidence remain missing, so live checkout stays disabled;
