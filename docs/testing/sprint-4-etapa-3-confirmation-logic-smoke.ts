...
import { buildConfirmationClassification } from "@/services/confirmation/build-confirmation-classification";

const now = new Date("2026-03-22T12:00:00.000Z");

const result = buildConfirmationClassification(
  [
    {
      client: {
    ...
    },
    {
      ...
      providerName: null,
      scheduledAt: new Date("2026-03-26T12:00:00.000Z"),
  ...
  JSON.stringify(
    {
      ...
      readyForConfirmationCount: result.readyForConfirmationCount,
