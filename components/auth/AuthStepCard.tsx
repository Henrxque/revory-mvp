...
export function AuthStepCard({
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-x-0 top-0 h-[4.5rem] bg-[linear-gradient(180deg,rgba(67,179,155,0.1),transparent)]" />

      <div className="relative flex h-full flex-col">
        <span className="inline-flex w-fit items-center rounded-full border border-[rgba(67,179,155,0.18)] bg-[rgba(67,179,155,0.08)] px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.24em] text-[color:var(--accent-light)]">
          {label}
        </span>
